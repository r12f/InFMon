...
| 0.2     | 2026-04-18 | Riff (r12f)   | Fix systemd unit default: disabled by default instead of enabled. Add `--run` install flag to opt in to enable+start. Update §6 notes, §7.1 install flow, §7.4 maintainer-script summary. Resolves contradiction with spec 000. |
