...
| `/etc/vpp/startup.d/10-infmon.conf`           | root  | 0644 | Disables plugin autoload by default (see spec 000). Operators flip `disable` → `enable` on instances where InFMon should run. |
