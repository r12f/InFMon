...
| 0.2     | 2026-04-18 | BF-3 (bf3)   | Add `/etc/vpp/startup.d/10-infmon.conf` (VPP plugin disable snippet) to §5.1 file layout and `debian/` source tree per spec 000 alignment. |
